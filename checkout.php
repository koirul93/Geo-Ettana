    ...
    <div class="row">
      ...
      <div class="table-responsive">
              ...
              <div class="panel-body">
                ...
                curl_setopt_array($curl, array(
                  ...
                  CURLOPT_HTTPHEADER => array(
                    "key:f281b43d90987dad51daf06a491f9ab7"
                  ),
                ));
                ...
                echo '<div class="form-group">
                        <input class="form-control" id="asal" type="hidden" name="asal" value="135">
                      </div>';
                //Get Data Kabupaten
                //-----------------------------------------------------------------------------
        ...
        <div class="alert alert-info text-center">
          <strong>
            <p>DIMOHON MENGISI DATA PENGIRIMAN DENGAN LENGKAP AGAR MEMPERMUDAH PENGIRIMAN</p>
          </strong>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    // $('#asal option:selected').attr('value','135');
    ...
    $('#provinsi').change(function() {
      ...
      $.ajax({
        type: 'GET',
        url: 'http://localhost/susuetawa/cek_kabupaten.php',
        data: 'prov_id=' + prov,
    ...
    $("#cek").click(function() {
      ...
      $.ajax({
        type: 'POST',
        url: 'http://localhost/susuetawa/cek_ongkir.php',
        data: {
          'kab_id': kab,
          'kurir': kurir,
          'asal': asal,
